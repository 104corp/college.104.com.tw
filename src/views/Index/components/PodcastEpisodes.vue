    ...
    <ul class="flex flex-col">
      ...
      >
        <a
          :href="episode.link"
          target="_blank"
          class="PodcastEpisodes__item group flex items-start gap-8"
          md="items-center gap-16"
        >
          <div
            class="PodcastEpisodes__item__img flex-shrink-0 overflow-hidden w-48 aspect-ratio-1 border border-gray-200 rounded-4"
            md="w-80 rounded-6"
          >
            <BaseImage
              :src="episode.image"
          ...
          <div class="min-w-0">
            <div
              class="PodcastEpisodes__item__title text-14 font-700 line-clamp-2"
              md="text-base group-hover:text-lake-200"
            >
              {{ episode.title }}
            </div>
            <div
              class="flex mt-8 text-(12 gray-500)"
              md="text-14"
            >
